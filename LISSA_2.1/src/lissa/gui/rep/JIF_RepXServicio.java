 ...
 * @author JSULCAG
 */
public class JIF_RepXServicio extends javax.swing.JInternalFrame {
    ...
    public JIF_RepXServicio(JF_Principal root) {
        initComponents();
        this.root = root;
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("REP0102 - Atenciones por Servicio");
    ...
    private void generarReporte() {
        try {
            ...
            reportPanel = reportGenric.mkReport("REP0102", new String[]{"ID_SERVICIO" ,"FECHA_DESDE", "FECHA_HASTA"}, new Object[]{((Servicio)cbxServicio.getSelectedItem()).getIdservicio(), jdcDesde.getDate(), jdcHasta.getDate()});
            ...
            Logger.getLogger(JIF_RepXServicio.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
