...
public class JIF_ReporteCajaMensual extends javax.swing.JInternalFrame {
    ...
    public JIF_ReporteCajaMensual(JF_Principal root) {
        initComponents();
        this.root = root;
    }
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(jYearChooser1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            reportPanel = reportGenric.mkReport("ReporteCajaPorMes", new String[]{"anio", "mes"}, new Object[]{anio, mes});
            ...
            Logger.getLogger(JIF_ReporteCajaMensual.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Exception ex) {
            Logger.getLogger(JIF_ReporteCajaMensual.class.getName()).log(Level.SEVERE, null, ex);
        }
